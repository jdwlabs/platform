...
var dryRunContract = map[string]bool{
	...
	"platformctl cluster alerts":                  false,
	...
	"platformctl cluster volumes truenas":         false,
	"platformctl cluster volumes truenas list":    false,
	"platformctl cluster volumes truenas reclaim": true,
