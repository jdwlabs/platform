...
<head>
    ...
    <style>
        ...
        .chart-meta {{ display: flex; justify-content: space-between; align-items: start; margin-bottom: 0.75rem; }}
...
<body>
    <div class="container">
        <header>
            <h1><a href="https://github.com/jdwlabs/platform">Jdwlabs Platform Helm Charts</a></h1>
